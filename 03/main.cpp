...
int main() {
    ...
    // Hough *houghTrasform1 = new Hough("data/input/Dataset3/1.bmp", "data/output/result1/1.bmp", "extra", 8);
    // Hough *houghTrasform2 = new Hough("data/input/Dataset3/2.bmp", "data/output/result1/1.bmp", "extra", 8);
    // Hough *houghTrasform3 = new Hough("data/input/Dataset3/3.bmp", "data/output/result1/1.bmp", "extra", 8);
